    ...
    <div className="flex flex-col items-center relative gap-36 py-20 overflow-hidden bg-gradient-to-l from-gray-900 to-blue-800">
      ...
      <div className="relative w-full h-[350px] my-36">
        ...
        <div className="bg-white text-secondary rounded-full w-72 sm:w-[550px] aspect-square flex flex-col justify-center items-center mx-auto shadow-lg shadow-purple-500/70 p-5 text-center z-10 ">
          <div className="w-[390px] flex flex-col gap-10">
            <h2 className="text-4xl font-bold text-shadow">Full-stack web development</h2>
      ...
      <div className="relative flex flex-col w-full h-[350px] my-36">
        <div className="bg-white text-white rounded-full w-72 sm:w-[550px] aspect-square flex flex-col justify-center items-center mx-auto shadow-lg shadow-purple-500/70 p-5 text-center ">
          <div className="relative text-secondary w-[390px] flex flex-col gap-5">
            <h2 className="text-4xl font-bold text-shadow">Professional video editing</h2>
            <p className="text-2xl font-bold">
      ...
      <div className="relative w-full h-[350px] my-36">
        ...
        <div className="bg-white text-secondary rounded-full w-72 sm:w-[550px] aspect-square flex flex-col justify-center items-center mx-auto shadow-lg shadow-purple-500/70 p-5 text-center z-10">
          <div className="relative text-secondary w-[390px] flex flex-col gap-5">
            ...
            <h2 className="text-4xl font-bold text-shadow">AWS cloud solutions</h2>
            <p className="text-2xl font-bold">
      ...
      <div className="relative w-full h-[350px] my-36 pb-36">
        ...
        <div className="bg-white text-secondary rounded-full w-72 sm:w-[550px] aspect-square flex flex-col justify-center items-center mx-auto shadow-lg shadow-purple-500/70 p-5 text-center z-10">
          <div className="relative text-secondary w-[390px] flex flex-col gap-5">
            <h2 className="text-4xl font-bold text-shadow">SEO and digital marketing</h2>
            <p className="text-2xl font-bold">
